...
function buildNav(members) {
    ...
    if (members.globals.length) {
        ...
        if (!globalNav) {
            ...
            nav += `<h3>${linkto('global', 'Usage')}</h3>`;
        }
        else {
            nav += `<h3>Usage</h3><ul>${globalNav}</ul>`;
        }
    }
...
exports.publish = (taffyData, opts, tutorials) => {
    ...
    generate(
		'<h2><a href="#">Welcome to parc.js</a></h2><p>Parc.js is a simple open source Javascript library, if you would contribute, or just view the repository you can go to <a href="https://github.com/leiloukou/parcjs">Github.com/Leiloukou/parcJS</a></p>',
		packages
			.concat([
				{
					kind: 'mainpage',
